...
| Al chiamante verrà chiesto di pronunciare il nome dell’utente o del servizio con cui vuole essere messo in contatto. Nel caso che l'utente non sia disponibile o non sia disturbabile consente la dettatura di un messaggio che verrà trascritto e inviato via chat all’utente richiesto.
